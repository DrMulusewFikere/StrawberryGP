...
###############################################################################
    ...
    ###########################
        ...
        ########################################
        # 2.6.1. GRM for cluster I (sub Tropical)
        ########################################
        ...
        ########################################
        # 2.6.2. GRM for cluster II (Temperate)
        ########################################
...
###############################################################################
    ...
    MT_Wfa1.asr <- update(MT_Gfa1.asr,
                              random = ~ 
                                at(T,c('P4')):B:D:X +
                                fa(AE23,1):vm(WAID, WGRM.giv) +
